...
if (isset($_POST['nis']) && isset($_POST['nm_siswa'])) { 
    ...
    $result = mysql_query("UPDATE siswa SET kd_kls = '$kd_kls', nm_siswa = '$nm_siswa', almt_siswa = '$almt_siswa', tgl_lhr_siswa = '$tgl_lhr_siswa', temp_lhr_siswa = '$temp_lhr_siswa', jns_klmn_siswa = '$jns_klmn_siswa', agm_siswa = '$agm_siswa', tlp_siswa = '$tlp_siswa', kls = '$kls' WHERE nis = '$' ");
    // check if row inserted or not
    if ($result) {
        $response["status"] = "edit siswa $nm_siswa berhasil ";
        $oke["d"] = $response;
