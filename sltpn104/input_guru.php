...
if (isset($_POST['nip']) && isset($_POST['nm_guru'])) { 
    ...
    $result = mysql_query("INSERT INTO guru(nip, nm_guru, jns_klmn_guru, temp_lhr_guru, tgl_lhr_guru, almt_guru, agm_guru, status_peg, thn_masuk, tgs_mgjr_mp, tlp_guru) VALUES ('$nip', '$nm_guru','$jns_klmn_guru', '$temp_lhr_guru', '$tgl_lhr_guru', '$almt_guru', '$agm_guru', '$status_peg', '$thn_masuk', '$tgs_mgjr_mp', '$tlp_guru') ");
    // check if row inserted or not
    if ($result) {
        $response["status"] = "input guru $nm_guru berhasil ";
        $oke["d"] = $response;
